...
export default function SantoNinoChurch() {
            ...
            <div className="container my-4">
                <div className="row align-items-center">
                    <div className="col-md-6">
                        <Image
                            src="/assets/photos/heritage/santo-nino-church.jpg"
                            alt="Santo Niño Church Malitbog"
                            width={600}
                            height={350}
                    ...
                    <div className="col-md-6">
                        <h1 className='mb-1 fw-bold'>Santo Niño de Malitbog Parish</h1>

                        <p className="text-muted">
                            <a href="https://www.google.com/maps/search/?api=1&query=Santo+Niño+de+Malitbog+Parish,+Malitbog+Main+Road,+Malitbog,+Southern+Leyte"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-decoration-none text-muted">
                                <i className="bi bi-geo-alt me-1"></i> Malitbog Main Road, Malitbog, Southern Leyte
                            </a>
                        </p>
                        ...
                        <p className='mt-3'>
                            Santo Niño Church in Malitbog, Southern Leyte, is a well-preserved Spanish-era landmark 
                            with Baroque architecture. Built from coral stones, it features intricate wooden altars
                            and centuries-old artifacts, making it a key pilgrimage and heritage site.
                        </p>
