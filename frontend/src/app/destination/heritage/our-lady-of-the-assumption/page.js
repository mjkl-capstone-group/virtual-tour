...
export default function OurLadyOfTheAssumption() {
            ...
            <div className="container my-4">
                <div className="row align-items-center">
                    <div className="col-md-6">
                        <Image
                            src="/assets/photos/heritage/lady-assumption.jpg"
                            alt="Our Lady of the Assumption"
                            width={600}
                            height={350}
                    ...
                    <div className="col-md-6">
                        <h1 className='mb-1 fw-bold'>Our Lady of the Assumption</h1>

                        <p className="text-muted">
                            <a href="https://www.google.com/maps/search/?api=1&query=Our+Lady+of+Assumption+Shrine,+Maasin+City,+Southern+Leyte"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-decoration-none text-muted">
                                <i className="bi bi-geo-alt me-1"></i> 4RPW+9GJ, Maasin City, Southern Leyte
                            </a>
                        </p>
                        ...
                        <p className='mt-3'>
                            Our Lady of the Assumption is a historic and sacred site in Southern Leyte, known for its deep religious significance.
                            The church is a prominent place of worship and pilgrimage, attracting visitors who seek spiritual reflection and solace.
                        </p>
