...
export default function CagnituanFalls() {
            ...
            <div className="container my-4">
                <div className="row align-items-center">
                    <div className="col-md-6">
                        <Image
                            src="/assets/photos/falls/cagnituan-falls.jpg"
                            alt="Cagnituan Falls"
                            width={600}
                            height={350}
                    ...
                    <div className="col-md-6">
                        <h1 className='mb-1 fw-bold'>Cagnituan Falls</h1>

                        <p className="text-muted">
                            <a href="https://www.google.com/maps/search/?api=1&query=Cagnituan+Falls,+Southern+Leyte"
                                target="_blank"
                        ...
                        <p className='mt-3'>
                            Cagnituan Falls in "Maasin City, Southern Leyte" is a hidden paradise with crystal-clear waters cascading into a natural pool, perfect for swimming and relaxation.
                        </p>
