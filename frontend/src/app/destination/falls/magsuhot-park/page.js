...
export default function MagsuhotPark() {
            ...
            <div className="container my-4">
                <div className="row align-items-center">
                    <div className="col-md-6">
                        <Image
                            src="/assets/photos/falls/magsuhot-park.jpg"
                            alt="Magsuhot Park"
                            width={600}
                            height={350}
                    ...
                    <div className="col-md-6">
                        <h1 className='mb-1 fw-bold'>Magsuhot Park</h1>

                        <p className="text-muted">
                            <a href="https://www.google.com/maps/search/?api=1&query=Magsuhot+Park,+Southern+Leyte"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-decoration-none text-muted">
                                <i className="bi bi-geo-alt me-1"></i> Magsuhot, Sogod, Southern Leyte, Philippines
                            </a>
                        </p>
                        ...
                        <p className='mt-3'>
                            Magsuhot Park in "Sogod, Southern Leyte" is a breathtaking eco-park featuring cascading waterfalls, lush greenery, and serene picnic areas, perfect for nature lovers and adventurers.
                        </p>
